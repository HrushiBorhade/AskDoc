...
const UserAccountNav = async ({
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="usernav font-sans" align="end">
        ...
        <DropdownMenuSeparator className="text-[rgba(255,255,255,0.1)]" />
        ...
        <DropdownMenuItem className="" asChild>
          {subscriptionPlan?.isSubscribed ? (
            ...
            <Link href="/pricing">
              Upgrade <Gem className="text-slate-300 h-3 w-3 ml-1" />
            </Link>
          )}
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
